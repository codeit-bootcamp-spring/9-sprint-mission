...
public interface MessageApi {
  ...
  ResponseEntity<Message> create(
      ...
      @Parameter(
          description = "Message 타입 정보", content = @Content(mediaType = MediaType.MULTIPART_FORM_DATA_VALUE))
  ...
  ResponseEntity<Void> delete(@RequestParam("messageId") UUID messageId
  );

  @Operation(summary = "Message 전체 목록 조회")
  @ApiResponses(value = {
      @ApiResponse(
