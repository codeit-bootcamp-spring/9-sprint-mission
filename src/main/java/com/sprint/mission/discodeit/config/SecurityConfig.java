...
public class SecurityConfig {
  ...
  public SessionRegistry sessionRegistry() {
    // Provides a SessionRegistry implementation so components depending on it (e.g. SessionManager)
    // can be autowired. Using the default SessionRegistryImpl from Spring Security.
