...
public class NotificationController {
  ...
  public ResponseEntity<List<NotificationDto>> findNotification(
    ...
    log.info("알림 조회 요청: receiverId={}", receiverId);
  ...
  public ResponseEntity<Void> deleteNotification(
      ...
      @AuthenticationPrincipal DiscodeitUserDetails userDetails) {
    UUID requestUserId = userDetails.getUserDto().id();
    log.info("알림 확인 요청: id={}, requestUserId={}", notificationId, requestUserId);
    notificationService.delete(notificationId, requestUserId);
