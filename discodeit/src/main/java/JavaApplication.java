...
public class JavaApplication {
    static void userCRUDTest(UserService userService) {
        // 생성
        User user = userService.create("RYUK", "ryuk6238@gmail.com", "01022790657");
        ...
        User foundUser = userService.find(user.getId());
            System.out.println("==== 유저 정보(단건) ====");
                ...
                System.out.println("유저 이름: " + foundUser.getuserName());
                System.out.println("유저 이메일: " + foundUser.getemail());
                System.out.println("유저 전화번호: " + foundUser.getphoneNumber());
        ...
        // 수정
        User updatedUser = userService.update(user.getId(), "YUK", "ryuk6238@naver.com", "01012341234");

            System.out.println("==== 유저 정보 수정 ====");
                System.out.println("유저 ID: " + updatedUser.getId());
                System.out.println("유저 이름: " + updatedUser.getuserName());
                System.out.println("유저 이메일: " + updatedUser.getemail());
                System.out.println("유저 전화번호: " + updatedUser.getphoneNumber());
