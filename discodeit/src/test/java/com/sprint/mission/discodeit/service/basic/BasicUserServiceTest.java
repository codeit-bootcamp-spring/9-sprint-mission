...
class BasicUserServiceTest {
  ...
  void update_success() {
    ...
    User user = new User("before", "before@test.com", "oldPassword", null);
    UserUpdateRequest request = new UserUpdateRequest("after", "after@test.com", "newPassword");
    BinaryContentCreateRequest profileRequest =
        new BinaryContentCreateRequest("profile.png", "image/png", new byte[]{1, 2, 3});

    BinaryContent savedProfile = new BinaryContent("profile.png", 3L, "image/png");
